...
const unsigned char APPLESOFT_BASIC[] = {
...
const unsigned char WOZ_MONITOR[] = {
...
const rom_block_t ROM_BLOCKS[] = {
    {0xE000, sizeof(APPLESOFT_BASIC),   APPLESOFT_BASIC },
    {0xFF00, sizeof(WOZ_MONITOR)    ,   WOZ_MONITOR     }};
